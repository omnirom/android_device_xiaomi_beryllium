...
VENDOR_RELEASE := 10/QKQ1.190828.002/V11.0.6.0.QEJMIXM:user/release-keys
...
OMNI_PRIVATE_BUILD_DESC := "'beryllium-user 10 QKQ1.190828.002 V11.0.6.0.QEJMIXM release-keys'"
